...
describe('BankAccount', () => {
  ...
  test('should create account with initial balance', () => {
    const account = getBankAccount(22);

    expect(account.getBalance()).toBe(22);
  });
  ...
  test('should throw InsufficientFundsError error when withdrawing more than balance', () => {
    ...
    expect(() => account.withdraw(23)).toThrow(
  ...
  test('should throw error when transferring more than balance', () => {
    ...
    expect(() => account.transfer(23, secondAccount)).toThrow(
      new InsufficientFundsError(balance),
    );
  });
  ...
  test('should deposit money', () => {
    ...
    expect(account.getBalance()).toBe(22);
    account.deposit(7);
    expect(account.getBalance()).toBe(29);
  });
